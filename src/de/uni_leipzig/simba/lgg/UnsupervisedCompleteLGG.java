 ...
 * @author sherif
 */
public class UnsupervisedCompleteLGG implements LGG {
	 ...
	 * @param minCoverage
	 */
	public UnsupervisedCompleteLGG(Cache source, Cache target, Mapping examples, double minCoverage) {
	...
	public static void main(String args[]) {
		...
		UnsupervisedCompleteLGG clgg = new UnsupervisedCompleteLGG(source, target, reference, 0.6);
