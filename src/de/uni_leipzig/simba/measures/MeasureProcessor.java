...
//                System.exit(1);
            ...
            else return measure.getSimilarity(sourceInstance, targetInstance, property1, property2);
        } else {
...
//                System.out.println(p.coef2);
     ...
     * 
     * @param measureExpression Expression
     * @param mappingSize Size of the mapping to process
